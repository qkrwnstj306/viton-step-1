...
class DDIMSampler:
    ...
    def train(self, model, x_0, cloth_agnostic_mask,
              densepose, cloth, resized_agn_mask, canny, image_embeddings, do_cfg, decoder=None, input_image=None):
        ...
        predicted_eps = model(x_t, cloth_agnostic_mask, densepose, cloth, resized_agn_mask, canny, 
                              image_embeddings, time_embedding.to("cuda"), do_cfg=do_cfg)
