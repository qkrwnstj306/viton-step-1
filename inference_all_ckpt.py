...
"""
CUDA_VISIBLE_DEVICES=2 python inference_all_ckpt.py --seed 23 --paired True --batch_size 4 --blending False
"""
...
def setting(weight="epoch=0-step=0.ckpt"):
    ...
    ckpt_pth = f'./weights/eps/eps/{weight}'
