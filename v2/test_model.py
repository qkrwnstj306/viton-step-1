...
class MyModel(nn.Module):
    ...
    def test_step(self, batch, batch_idx):
        ...
        input_latents, cloth_agnostic_mask_latents, densepose_latents, cloth_latents = \
            torch.chunk(self.encoder(encoder_inputs, encoder_noise), 4, dim=0)
        ...
        x_0 = self.sampler.DDIM_sampling(self.diffusion, x_T, cloth_agnostic_mask_latents,
                                         densepose_latents, cloth_latents, resized_agn_mask, image_embeddings, input_latents, do_cfg=CFG)
    ...
    def extract_feature_map(self, batch, batch_idx, block_index):
        ...
        x_0 = self.sampler.DDIM_sampling(self.diffusion, x_T, cloth_agnostic_mask_latents,
                                         densepose_latents, cloth_latents, resized_agn_mask, image_embeddings, do_cfg=CFG, img_callback=ddim_sampler_callback, callback_interval=save_interval)
